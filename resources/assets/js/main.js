(function () {
    ...
    function localStorageBackup() {
        ...
        //     }, 5000);
        // }
        if (localStorage.nowalayout) {
            let html = document.querySelector('html');
            let layoutValue = localStorage.getItem('nowalayout');
        ...
        if (localStorage.nowaverticalstyles) {
            let html = document.querySelector('html');
            let verticalStyles = localStorage.getItem('nowaverticalstyles');
            ...
            if (verticalStyles == "doublemenu") {
                ...
                setTimeout(() => {
                    ...
                    // CreateRequest the tooltip element
                    ...
                    menuSlideItem.forEach((e) => {
                        ...
                        e.addEventListener("mouseenter", () => {
                            if (localStorage.nowaverticalstyles == "doublemenu") {
        ...
        if (localStorage.nowanavstyles) {
            let html = document.querySelector('html');
            let navStyles = localStorage.getItem('nowanavstyles');
        ...
        if (localStorage.nowaclassic) {
            let html = document.querySelector('html');
            html.setAttribute('data-page-style', 'classic');
        }
        if (localStorage.nowamodern) {
            let html = document.querySelector('html');
            html.setAttribute('data-page-style', 'modern');
        }
        if (localStorage.nowaboxed) {
            let html = document.querySelector('html');
            html.setAttribute('data-width', 'boxed');
        }
        if (localStorage.nowaheaderfixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'fixed');
        }
        if (localStorage.nowaheaderscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'scrollable');
        }
        if (localStorage.nowamenufixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'fixed');
        }
        if (localStorage.nowamenuscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'scrollable');
        }
        if (localStorage.nowaMenu) {
            let html = document.querySelector('html');
            let menuValue = localStorage.getItem('nowaMenu');
            switch (menuValue) {
                case 'light':
        ...
        if (localStorage.nowaHeader) {
            let html = document.querySelector('html');
            let headerValue = localStorage.getItem('nowaHeader');
            switch (headerValue) {
                case 'light':
