<x-app-layout title="Edit KYC Document" for="superadmin">
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item">
            <span>Kyc Documents</span>
        </li>
        <li class="breadcrumb-item active">
            <span>Edit KYC Document</span>
        </li>
    </x-slot>
            ...
            <div class="col-md-6 mx-auto">
                <div class="card mb-4">
                    <div class="card-header">
                        {{ __('Edit KYC Document') }}
                    </div>
                    <div class="card-body">
                        <form action="{{ route('superadmin.kyc-docs.update', ['kyc_doc' => $kycDoc]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name', $kycDoc->name) }}">
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="required"
                                        ...
                                        {{ old('required', $kycDoc->required) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="has_id_number"
                                        ...
                                        {{ old('has_id_number', $kycDoc->has_id_number) ? 'checked' : '' }}>
                                    <label class="form-check-label"
                            ...
                            <div id="when_id_number" class="card p-2 mb-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="id_required"
                                            ...
                                            {{ old('id_required', $kycDoc->id_required) ? 'checked' : '' }}>
                                        <label class="form-check-label"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('id_regex') is-invalid @enderror"
                                        id="id_regex" name="id_regex"
                                        value="{{ old('id_regex', $kycDoc->id_regex) }}">
                                    @error('id_regex')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="has_name" name="has_name"
                                        value="1" role="switch"
                                        {{ old('has_name', $kycDoc->has_name) ? 'checked' : '' }}>
                                    <label class="form-check-label"
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="name_required"
                                            ...
                                            {{ old('name_required', $kycDoc->name_required) ? 'checked' : '' }}>
                                        <label class="form-check-label"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="has_expiration_date"
                                        ...
                                        {{ old('has_expiration_date', $kycDoc->has_expiration_date) ? 'checked' : '' }}>
                                    <label class="form-check-label"
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="expiration_date_required"
                                            ...
                                            {{ old('expiration_date_required', $kycDoc->expiration_date_required) ? 'checked' : '' }}>
                                        <label class="form-check-label"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('number_of_pages') is-invalid @enderror"
                                    ...
                                    <option value="0"
                                        {{ old('number_of_pages', $kycDoc->number_of_pages) == '0' ? 'selected' : '' }}>
                                        Not
                                        Sure</option>
                                    @foreach (range(1, 10) as $item)
                                        <option value="{{ $item }}"
                                            {{ old('number_of_pages', $kycDoc->number_of_pages) == $item ? 'selected' : '' }}>
                                            {{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
