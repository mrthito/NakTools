<x-app-layout title="Dashboard">
    <div class="container-xl">
        <div class="alert alert-danger">
            {{ __('Your KYC is not verified yet. Please verify your KYC to start trading.') }}
            {!! __('<a href=":link">Click here</a> to start verification process.', ['link' => route('u.kyc.index')]) !!}
        </div>
                ...
                <div class="card card-sm">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <span
                                    class="bg-yellow text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/message -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
