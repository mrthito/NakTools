...
<body>
                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <div class="btn-list">
                                ...
                                <div class="dropdown d-none d-sm-inline">
                                    <button class="btn btn-outline-primary btn-icon dropdown-toggle px-3" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        {{ Auth::user()->name }}
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('u.profile.edit') }}">
                                                {{ __('Profile') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('u.dashboard.index') }}">
                                                {{ __('Settings') }}
                                            </a>
                                        </li>
                                        <li>
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    ...
                                    <a href="https://ipatco.com" class="link-secondary">iPatco</a>.
                ...
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <div class="d-flex">
                            ...
                            <h5 class="modal-title ms-2">{{ __('Are you sure you want to logout?') }}</h5>
                        </div>
    ...
    <!-- Libs JS -->
    <script src="/assets/user/libs/apexcharts/dist/apexcharts.min.js" defer></script>
    <script src="/assets/user/libs/jsvectormap/dist/js/jsvectormap.min.js" defer></script>
    <script src="/assets/user/libs/jsvectormap/dist/maps/world.js" defer></script>
    <script src="/assets/user/libs/jsvectormap/dist/maps/world-merc.js" defer></script>
    <!-- Tabler Core -->
